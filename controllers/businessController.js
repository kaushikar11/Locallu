...
// Get business details by UID
// exports.getBusinessByUID = async (req, res) => {
//     const uid = req.params.uid;

//     try {
//         const businessesSnapshot = await db.collection('businesses').where('uid', '==', uid).get();
        
//         if (businessesSnapshot.empty) {
//             return res.status(404).send('Business not found');
//         }

//         const businessDetails = businessesSnapshot.docs.map(doc => doc.data())[0];
...
//         // Example query to fetch business details associated with the user
